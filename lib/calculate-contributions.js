...
//var auth = {
//   user: 'auth key', //<- you can get one of these from https://github.com/settings/applications#personal-access-tokens
//  pass: 'x-oauth-basic'
//};
var auth = {};
...
request.get({
    ...
    headers: {
        ...
        'Authorization': 'token d09c7c6aae2406fd22d2027181b843bda50b1b0c'
    },
    //auth: auth
    ...
    allModules = allModules.filter(function (moduleName) {
        return !_.contains(pack.excludedOrgModules, moduleName);
    });
